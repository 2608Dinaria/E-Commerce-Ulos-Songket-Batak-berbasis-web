...
?>
    ...
    <!-- Hero Section Seremonial -->
    <section class="hero-adat">
        <div class="hero-adat-text">
            <h2>Koleksi Pilihan untuk Acara Seremonial</h2>
            <p>Pilih ulos atau songket terbaik untuk melengkapi momen istimewa dalam acara seremonial anda</p>
        </div>
        <div class="hero-adat-image">
            <img src="assets/img/seremonial.jpg" alt="Acara Seremonial">
        </div>
    </section>
    ...
    <section class="latest-collection" style="background: #fff;">
        <div style="display: flex; gap: 30px; max-width: 1200px; margin: 0 auto; padding: 0 20px; align-items: flex-start;">
            ...
            <div class="filter-sidebar" style="flex: 0 0 250px; background: #f9f9f9; padding: 20px; border-radius: 8px; border: 1px solid #eee;">
                ...
                <form action="kategori_seremonial.php" method="GET">
                    <!-- Price Range -->
                    ...
                    <?php if(isset($_GET['min_price']) || isset($_GET['max_price'])): ?>
                        <a href="kategori_seremonial.php" style="display: block; text-align: center; margin-top: 10px; color: red; text-decoration: underline; font-size: 0.9rem;">Reset Filter</a>
                    <?php endif; ?>
                </form>
            </div>
            ...
            <?php
            // Build Query
            $conditions = ["(category = 'Acara Seremonial' OR category = 'Seremonial')"];
