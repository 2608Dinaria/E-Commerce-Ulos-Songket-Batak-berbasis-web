...
?>
    ...
    <section class="hero-adat">
        <div class="hero-adat-text">
            <h2>Koleksi Pilihan untuk Acara Adat</h2>
            <p>Pilih ulos atau songket terbaik untuk melengkapi momen istimewa dalam acara adat anda</p>
        </div>
        <div class="hero-adat-image">
            <img src="assets/img/acara adat.jpeg" alt="Acara Adat">
        </div>
    </section>
    ...
    <section class="latest-collection" style="background: #fff;">
        <div style="display: flex; gap: 30px; max-width: 1200px; margin: 0 auto; padding: 0 20px; align-items: flex-start;">
            ...
            <div class="filter-sidebar" style="flex: 0 0 250px; background: #f9f9f9; padding: 20px; border-radius: 8px; border: 1px solid #eee;">
                ...
                <form action="kategori_adat.php" method="GET">
                    <!-- Price Range -->
                    ...
                    <?php if(isset($_GET['min_price']) || isset($_GET['max_price'])): ?>
                        <a href="kategori_adat.php" style="display: block; text-align: center; margin-top: 10px; color: red; text-decoration: underline; font-size: 0.9rem;">Reset Filter</a>
                    <?php endif; ?>
                </form>
            </div>
            ...
            // Temporarily removed LIMIT to show filtered results properly, or stick to LIMIT 12
            $sql .= " LIMIT 12"; 
